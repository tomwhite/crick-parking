...
We analysed ticket data for the two machines in Crickhowell's Long Stay car park from January to May 2019.
...
4. The car park is very likely to be overcrowed on Saturdays and Bank Holidays, especially in good weather.
5. Monthly usage increases through the year, with May being 50% busier than January.

## Approach

The summary statistics for ticket popularity, and busy times were performed with standard statistical analysis (see the end of this document). For analysing overcrowding we carried out a more involved analysis described next.

Each ticket sold is one of: 1 hour, 2 hour, 4 hour, all day - for cars. We ignored tickets for other categories of vehicle since they are tiny in comparison with those for cars.

We considered the period from 8am to 6pm, since this is when charges apply. We made the simplifying assumption that each ticket was used for the full amount of time allowed, so for example a 2 hour ticket would be used for 2 hours. Of course, this is not a realistic assmption, since it overcounts vehicles that leave before the ticket expires. On the other hand, it undercounts vehicles that overstay, or those with no ticket at all. It's not possible to estimate the relative importance of these two effects without further information (such as data from spot surveys).
...
For example, here is the graph for 4 April:

![Crickhowell Car Park, 4 April 2019](out/2019/04/04/plot.png)
...
![Crickhowell Car Park, 27 May 2019](out/2019/05/27/plot.png)

It's clear that the car park was a lot busier on this day, as the peak estimated occupancy was around 140. (There are only 130 spaces, so the assumption that everyone stayed for the full time on their ticket must have broken down.) Notice the rapid drop in the orange line at midday, from over 40 tickets being sold per 30 minute period, to 10 tickets being sold per 30 minute period. Since the estimated occupancy was around 120 at this time, this rapid drop can be interpreted as the car park being full.

The key insight here is that we can detect when the car park is full by looking for very rapid drops in ticket sales.

From a visual scan of graphs for the data set, this happened on the following days:
...
Crickhowell had heavy snow on 1 February, and it shows in very light car park usage:

![Crickhowell Car Park, 1 February 2019](out/2019/02/01/plot.png)

And on 3 March Storm Freya hit, so few people ventured in to town:

![Crickhowell Car Park, 3 March 2019](out/2019/03/03/plot.png)
